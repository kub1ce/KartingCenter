...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-2xl font-bold text-gray-800 mb-6">Добавить карт</h1>
        ...
        <form action="{{ route('admin.karts.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="number" id="number" value="{{ old('number') }}" 
                       class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('number') border-red-500 @enderror" placeholder="Например: 05">
                @error('number')
            ...
            <div class="mb-4">
                ...
                <select name="kart_type_id" id="kart_type_id" 
                    ...
                    @foreach ($kartTypes as $type)
                        <option value="{{ $type->id }}" {{ old('kart_type_id') == $type->id ? 'selected' : '' }}>
