...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-2xl font-bold text-gray-800 mb-6">Новая акция</h1>
    ...
    <div class="bg-white p-6 rounded shadow-md max-w-2xl">
        <form action="{{ route('admin.promotions.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="discount_percent" id="discount_percent" min="1" max="99" value="{{ old('discount_percent') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            ...
            <div class="flex gap-4 mb-4">
                ...
                <div class="w-1/2">
                    ...
                    <input type="date" name="end_date" id="end_date" value="{{ old('end_date') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    @error('end_date')
                        <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="mb-6">
                <label class="flex items-center">
                    <input type="checkbox" name="is_active" value="1" class="form-checkbox h-5 w-5 text-blue-600" @checked(old('is_active', true))>
                    <span class="ml-2 text-gray-700 text-sm font-bold">Сразу активировать</span>
                </label>
            </div>
