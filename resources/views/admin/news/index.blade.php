...
<div>
    <div class="flex justify-between items-center mb-8">
        <h1 class="text-2xl font-black text-white uppercase tracking-wider border-l-4 border-lime-500 pl-4">Управление новостями</h1>
        <a href="{{ route('admin.news.create') }}" class="bg-lime-500 hover:bg-lime-400 text-black px-5 py-2 font-black uppercase text-xs tracking-widest transition hover:shadow-[0_0_15px_rgba(163,230,53,0.4)]">
            + Добавить новость
        </a>
    </div>
        ...
        <table class="min-w-full">
            <thead>
                <tr class="bg-white/5 border-b border-white/10">
                    <th class="py-4 px-6 text-left text-[10px] font-black text-gray-500 uppercase tracking-widest">Заголовок</th>
                    <th class="py-4 px-6 text-center text-[10px] font-black text-gray-500 uppercase tracking-widest">Статус</th>
                    <th class="py-4 px-6 text-center text-[10px] font-black text-gray-500 uppercase tracking-widest">Дата</th>
                    <th class="py-4 px-6 text-center text-[10px] font-black text-gray-500 uppercase tracking-widest">Действия</th>
                </tr>
            </thead>
            <tbody class="text-gray-400 text-sm">
                ...
                <tr class="border-b border-white/5 hover:bg-lime-500/5 transition-colors">
                    ...
                    <td class="py-4 px-6 text-center font-mono text-xs text-gray-500">
